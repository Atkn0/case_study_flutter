...
class HomeViewModel extends ChangeNotifier {
  ...
  final List<Podcast> _dummyData = [
    Podcast(
      ...
      author: 'John Doe',
      coverImageUrl: 'assets/images/podcast_1.png',
      category: 'Life',
    ),
    Podcast(
      id: '2',
      ...
      author: 'Jane Smith',
      coverImageUrl: 'assets/images/podcast_2.png',
      category: 'Tech',
    ),
    Podcast(
      id: '3',
      title: 'Laugh Factory',
      author: 'Comedian X',
      coverImageUrl: 'assets/images/podcast_3.png',
      category: 'Comedy',
    ),
    Podcast(
      id: '4',
      title: 'Life Hacks',
      author: 'LifeGuru',
      coverImageUrl: 'assets/images/podcast_4.png',
      category: 'Life',
    ),
    Podcast(
      id: '5',
